...
function svgMapWrapper(svgPanZoom) {
  ...
  if (this.options.data.values[countryID]) {
    ...
    ['Payment Method', 'Transaction Fee', 'Settlement Times', 'Mid-Market Reference', 'Total Fee'].forEach(function(header) {
    ...
    if (Array.isArray(countryData.methods)) {
      countryData.methods.forEach(function(method) {
        ...
        ['method', 'fee', 'settlement', 'market', 'total'].forEach(function(key) {
